...
@RestController
@RequestMapping("/api/wcc301")
public class Wcc301Resource {

    private final Logger log = LoggerFactory.getLogger(Wcc301Resource.class);

    private static final String ENTITY_NAME = "wcc301";
