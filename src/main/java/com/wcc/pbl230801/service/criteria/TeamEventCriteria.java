...
/**
 * Criteria class for the {@link com.wcc.pbl230801.domain.TeamEvent} entity. This class is used
 * in {@link com.wcc.pbl230801.web.rest.TeamEventResource} to receive all the possible filtering options from
...
public class TeamEventCriteria implements Serializable, Criteria {
    ...
    @Override
    public int hashCode() {
        return Objects.hash(id, tId, eId, lstMtnUsr, lstMtnDt, distinct);
    }
