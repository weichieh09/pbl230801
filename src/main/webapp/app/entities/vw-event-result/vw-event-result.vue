  ...
  <div>
    <h2 id="page-heading" data-cy="VwEventResultHeading">
      ...
      <div class="d-flex justify-content-end">
        ...
        <router-link :to="{ name: 'VwEventResultCreate' }" custom v-slot="{ navigate }">
          <button
            @click="navigate"
            id="jh-create-entity"
            data-cy="entityCreateButton"
            class="btn btn-primary jh-create-entity create-vw-event-result"
          >
            <font-awesome-icon icon="plus"></font-awesome-icon>
            <span> Create a new Vw Event Result </span>
          </button>
        </router-link>
      </div>
    </h2>
          ...
          <tr v-for="vwEventResult in vwEventResults" :key="vwEventResult.id" data-cy="entityTable">
            ...
            <td class="text-right">
              <div class="btn-group">
                ...
                <b-button
                  v-on:click="prepareRemove(vwEventResult)"
                  variant="danger"
                  class="btn btn-sm"
