...
export default class VwEventResult extends Vue {
  ...
  public prepareRemove(instance: IVwEventResult): void {
  ...
  public removeVwEventResult(): void {
    this.vwEventResultService()
      .delete(this.removeId)
      .then(() => {
        const message = 'A VwEventResult is deleted with identifier ' + this.removeId;
