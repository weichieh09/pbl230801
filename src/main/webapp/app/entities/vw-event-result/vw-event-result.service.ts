...
export default class VwEventResultService {
  ...
  public create(entity: IVwEventResult): Promise<IVwEventResult> {
    return new Promise<IVwEventResult>((resolve, reject) => {
      axios
  ...
  public update(entity: IVwEventResult): Promise<IVwEventResult> {
    return new Promise<IVwEventResult>((resolve, reject) => {
      axios
  ...
  public partialUpdate(entity: IVwEventResult): Promise<IVwEventResult> {
    return new Promise<IVwEventResult>((resolve, reject) => {
      axios
