...
export default class TeamPlayer extends Vue {
  ...
  public teamPlayers: ITeamPlayer[] = [];

  public isFetching = false;

  public mounted(): void {
    this.retrieveAllTeamPlayers();
  }
  ...
  public retrieveAllTeamPlayers(): void {
  ...
  public prepareRemove(instance: ITeamPlayer): void {
  ...
  public removeTeamPlayer(): void {
    this.teamPlayerService()
      .delete(this.removeId)
      .then(() => {
        const message = 'A TeamPlayer is deleted with identifier ' + this.removeId;
