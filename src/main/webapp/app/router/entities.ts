...
// prettier-ignore
const VwEventResultUpdate = () => import('@/entities/vw-event-result/vw-event-result-update.vue');
// prettier-ignore
...
export default {
  ...
  children: [
    ...
    {
      path: 'vw-event-result/new',
      name: 'VwEventResultCreate',
      component: VwEventResultUpdate,
      meta: { authorities: [Authority.USER] },
    },
    {
      path: 'vw-event-result/:vwEventResultId/edit',
      name: 'VwEventResultEdit',
      component: VwEventResultUpdate,
      meta: { authorities: [Authority.USER] },
    },
    {
