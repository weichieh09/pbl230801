...
describe('Component Tests', () => {
  describe('Player Management Component', () => {
    ...
    it('should not load a page if the page is the same as the previous page', () => {
      // GIVEN
      playerServiceStub.retrieve.reset();
      comp.previousPage = 1;
      ...
      // THEN
      expect(playerServiceStub.retrieve.called).toBeFalsy();
    });
    ...
    it('should re-initialize the page', async () => {
      ...
      // THEN
      expect(playerServiceStub.retrieve.callCount).toEqual(3);
    ...
    it('Should call delete service on confirmDelete', async () => {
      ...
      expect(playerServiceStub.retrieve.callCount).toEqual(1);
