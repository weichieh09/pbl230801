...
import TeamPlayerUpdateComponent from '@/entities/team-player/team-player-update.vue';
import TeamPlayerClass from '@/entities/team-player/team-player-update.component';
...
describe('Component Tests', () => {
  describe('TeamPlayer Management Update Component', () => {
    ...
    beforeEach(() => {
      ...
      wrapper = shallowMount<TeamPlayerClass>(TeamPlayerUpdateComponent, {
        store,
        localVue,
        router,
        provide: {
    ...
    describe('save', () => {
      it('Should call update service on save for existing entity', async () => {
        // GIVEN
        const entity = { id: 123 };
        comp.teamPlayer = entity;
        teamPlayerServiceStub.update.resolves(entity);
        ...
        // THEN
        expect(teamPlayerServiceStub.update.calledWith(entity)).toBeTruthy();
      ...
      it('Should call create service on save for new entity', async () => {
        ...
        const entity = {};
        comp.teamPlayer = entity;
        teamPlayerServiceStub.create.resolves(entity);
        ...
        // THEN
        expect(teamPlayerServiceStub.create.calledWith(entity)).toBeTruthy();
        expect(comp.isSaving).toEqual(false);
      });
    });
    ...
    describe('Before route enter', () => {
      it('Should retrieve data', async () => {
        ...
        teamPlayerServiceStub.retrieve.resolves([foundTeamPlayer]);
