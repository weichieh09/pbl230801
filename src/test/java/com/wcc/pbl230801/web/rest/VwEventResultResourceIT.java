...
class VwEventResultResourceIT {
    ...
    @Test
    @Transactional
    void createVwEventResult() throws Exception {
        int databaseSizeBeforeCreate = vwEventResultRepository.findAll().size();
        // Create the VwEventResult
        VwEventResultDTO vwEventResultDTO = vwEventResultMapper.toDto(vwEventResult);
        restVwEventResultMockMvc
            .perform(
                post(ENTITY_API_URL).contentType(MediaType.APPLICATION_JSON).content(TestUtil.convertObjectToJsonBytes(vwEventResultDTO))
            )
            .andExpect(status().isCreated());

        // Validate the VwEventResult in the database
        List<VwEventResult> vwEventResultList = vwEventResultRepository.findAll();
        assertThat(vwEventResultList).hasSize(databaseSizeBeforeCreate + 1);
        VwEventResult testVwEventResult = vwEventResultList.get(vwEventResultList.size() - 1);
        assertThat(testVwEventResult.geteId()).isEqualTo(DEFAULT_E_ID);
        assertThat(testVwEventResult.getpId()).isEqualTo(DEFAULT_P_ID);
        assertThat(testVwEventResult.getmId()).isEqualTo(DEFAULT_M_ID);
        assertThat(testVwEventResult.getWinFg()).isEqualTo(DEFAULT_WIN_FG);
        assertThat(testVwEventResult.getPlyrNm()).isEqualTo(DEFAULT_PLYR_NM);
        assertThat(testVwEventResult.getPlyrLvl()).isEqualTo(DEFAULT_PLYR_LVL);
        assertThat(testVwEventResult.getMtchEndTime()).isEqualTo(DEFAULT_MTCH_END_TIME);
        assertThat(testVwEventResult.getTotMatchs()).isEqualTo(DEFAULT_TOT_MATCHS);
        assertThat(testVwEventResult.getTotWins()).isEqualTo(DEFAULT_TOT_WINS);
        assertThat(testVwEventResult.getAcmlWins()).isEqualTo(DEFAULT_ACML_WINS);
        assertThat(testVwEventResult.getChkFg()).isEqualTo(DEFAULT_CHK_FG);
    }

    @Test
    @Transactional
    void createVwEventResultWithExistingId() throws Exception {
        // Create the VwEventResult with an existing ID
        vwEventResult.setId(1L);
        VwEventResultDTO vwEventResultDTO = vwEventResultMapper.toDto(vwEventResult);
        ...
        // Validate the VwEventResult in the database
        List<VwEventResult> vwEventResultList = vwEventResultRepository.findAll();
        assertThat(vwEventResultList).hasSize(databaseSizeBeforeCreate);
    }
    ...
    @Test
    @Transactional
    void putExistingVwEventResult() throws Exception {
        // Initialize the database
        vwEventResultRepository.saveAndFlush(vwEventResult);

        int databaseSizeBeforeUpdate = vwEventResultRepository.findAll().size();

        // Update the vwEventResult
        VwEventResult updatedVwEventResult = vwEventResultRepository.findById(vwEventResult.getId()).get();
        // Disconnect from session so that the updates on updatedVwEventResult are not directly saved in db
        em.detach(updatedVwEventResult);
        updatedVwEventResult
            .eId(UPDATED_E_ID)
            .pId(UPDATED_P_ID)
            .mId(UPDATED_M_ID)
            .winFg(UPDATED_WIN_FG)
            ...
            .acmlWins(UPDATED_ACML_WINS)
            .chkFg(UPDATED_CHK_FG);
        VwEventResultDTO vwEventResultDTO = vwEventResultMapper.toDto(updatedVwEventResult);

        restVwEventResultMockMvc
            .perform(
                put(ENTITY_API_URL_ID, vwEventResultDTO.getId())
                    .contentType(MediaType.APPLICATION_JSON)
                    .content(TestUtil.convertObjectToJsonBytes(vwEventResultDTO))
            )
            .andExpect(status().isOk());

        // Validate the VwEventResult in the database
        List<VwEventResult> vwEventResultList = vwEventResultRepository.findAll();
        assertThat(vwEventResultList).hasSize(databaseSizeBeforeUpdate);
        VwEventResult testVwEventResult = vwEventResultList.get(vwEventResultList.size() - 1);
        assertThat(testVwEventResult.geteId()).isEqualTo(UPDATED_E_ID);
        assertThat(testVwEventResult.getpId()).isEqualTo(UPDATED_P_ID);
        assertThat(testVwEventResult.getmId()).isEqualTo(UPDATED_M_ID);
        assertThat(testVwEventResult.getWinFg()).isEqualTo(UPDATED_WIN_FG);
        assertThat(testVwEventResult.getPlyrNm()).isEqualTo(UPDATED_PLYR_NM);
        assertThat(testVwEventResult.getPlyrLvl()).isEqualTo(UPDATED_PLYR_LVL);
        assertThat(testVwEventResult.getMtchEndTime()).isEqualTo(UPDATED_MTCH_END_TIME);
        assertThat(testVwEventResult.getTotMatchs()).isEqualTo(UPDATED_TOT_MATCHS);
        assertThat(testVwEventResult.getTotWins()).isEqualTo(UPDATED_TOT_WINS);
        assertThat(testVwEventResult.getAcmlWins()).isEqualTo(UPDATED_ACML_WINS);
        assertThat(testVwEventResult.getChkFg()).isEqualTo(UPDATED_CHK_FG);
    }

    @Test
    @Transactional
    void putNonExistingVwEventResult() throws Exception {
        int databaseSizeBeforeUpdate = vwEventResultRepository.findAll().size();
        vwEventResult.setId(count.incrementAndGet());
    ...
    @Test
    @Transactional
    void putWithIdMismatchVwEventResult() throws Exception {
        int databaseSizeBeforeUpdate = vwEventResultRepository.findAll().size();
        vwEventResult.setId(count.incrementAndGet());
    ...
    @Test
    @Transactional
    void putWithMissingIdPathParamVwEventResult() throws Exception {
        int databaseSizeBeforeUpdate = vwEventResultRepository.findAll().size();
        vwEventResult.setId(count.incrementAndGet());
        ...
        restVwEventResultMockMvc
            .perform(
                put(ENTITY_API_URL).contentType(MediaType.APPLICATION_JSON).content(TestUtil.convertObjectToJsonBytes(vwEventResultDTO))
            )
    ...
    @Test
    @Transactional
    void partialUpdateVwEventResultWithPatch() throws Exception {
        // Initialize the database
        vwEventResultRepository.saveAndFlush(vwEventResult);

        int databaseSizeBeforeUpdate = vwEventResultRepository.findAll().size();

        // Update the vwEventResult using partial update
        VwEventResult partialUpdatedVwEventResult = new VwEventResult();
        partialUpdatedVwEventResult.setId(vwEventResult.getId());

        partialUpdatedVwEventResult
            .eId(UPDATED_E_ID)
            .pId(UPDATED_P_ID)
            .mId(UPDATED_M_ID)
            .totMatchs(UPDATED_TOT_MATCHS)
        ...
        restVwEventResultMockMvc
            .perform(
                patch(ENTITY_API_URL_ID, partialUpdatedVwEventResult.getId())
                    .contentType("application/merge-patch+json")
                    .content(TestUtil.convertObjectToJsonBytes(partialUpdatedVwEventResult))
            )
            .andExpect(status().isOk());
    ...
    @Test
    @Transactional
    void fullUpdateVwEventResultWithPatch() throws Exception {
        // Initialize the database
        vwEventResultRepository.saveAndFlush(vwEventResult);
    ...
    @Test
    @Transactional
    void patchNonExistingVwEventResult() throws Exception {
        int databaseSizeBeforeUpdate = vwEventResultRepository.findAll().size();
        vwEventResult.setId(count.incrementAndGet());
        ...
        restVwEventResultMockMvc
            .perform(
                patch(ENTITY_API_URL_ID, vwEventResultDTO.getId())
                    .contentType("application/merge-patch+json")
                    .content(TestUtil.convertObjectToJsonBytes(vwEventResultDTO))
            )
            .andExpect(status().isBadRequest());
    ...
    @Test
    @Transactional
    void patchWithIdMismatchVwEventResult() throws Exception {
        int databaseSizeBeforeUpdate = vwEventResultRepository.findAll().size();
        vwEventResult.setId(count.incrementAndGet());
    ...
    @Test
    @Transactional
    void patchWithMissingIdPathParamVwEventResult() throws Exception {
        int databaseSizeBeforeUpdate = vwEventResultRepository.findAll().size();
        vwEventResult.setId(count.incrementAndGet());
    ...
    @Test
    @Transactional
    void deleteVwEventResult() throws Exception {
        // Initialize the database
        vwEventResultRepository.saveAndFlush(vwEventResult);

        int databaseSizeBeforeDelete = vwEventResultRepository.findAll().size();

        // Delete the vwEventResult
        restVwEventResultMockMvc
            .perform(delete(ENTITY_API_URL_ID, vwEventResult.getId()).accept(MediaType.APPLICATION_JSON))
            .andExpect(status().isNoContent());

        // Validate the database contains one less item
        List<VwEventResult> vwEventResultList = vwEventResultRepository.findAll();
        assertThat(vwEventResultList).hasSize(databaseSizeBeforeDelete - 1);
    }
}
